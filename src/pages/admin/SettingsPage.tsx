...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-700 pb-32 px-4 md:px-6 lg:px-8">
      {/* Header - Surgery View */}
      <div className="flex flex-col xl:flex-row justify-between items-stretch xl:items-center gap-6 bg-white p-5 md:p-8 rounded-[2.5rem] border border-stone-100 shadow-sm relative overflow-hidden group">
        ...
        <div className="flex items-center gap-4 md:gap-6 relative z-10">
          ...
          <div className="min-w-0">
            <h1 className="text-2xl md:text-3xl font-black text-stone-900 tracking-tight leading-none uppercase">Configuration</h1>
            <p className="text-stone-400 text-xs md:text-sm font-bold mt-2 truncate tracking-wide uppercase">Identité • Logistique • Design System</p>
          </div>
        </div>
