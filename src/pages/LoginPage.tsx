                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="block w-full pl-11 bg-black/50 border border-white/10 rounded-xl py-3 text-white placeholder-gray-600 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all sm:text-sm"
                            placeholder="••••••••"
                        />
                    </div>
                </div>
